        ...
        <div id = "wrapper">
            ...
            <form method = "POST" class = "form">
                ...
                <p id = "sendbuttoncover">
                    <input type = "submit" value = "確定" id = "sendbutton" formaction = "usermodified?id={{id}}">
                    <input type = "submit" value = "修正" id = "modifybutton" formaction = "usermodify?modify=True&id={{id}}">
                </p>
