        ...
        <div id = "wrapper">
            ...
            <form method = "POST">
                ...
                <p id = "sendbuttoncover">
                    <input type = "submit" value = "貸出" id = "sendbutton" formaction = "lended?id={{id}}&fm={{fm}}">
                    <input type = "submit" value = "取消" id = "modifybutton" formaction = "lend">
                </p>
        </div>
    </body>
    <footer>
