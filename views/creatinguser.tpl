...
<html>
    <head>
        <meta charset = "utf-8">
        <title>ユーザ作成 - 研究室 蔵書管理システム - 管理用</title>
            ...
            <form method = "POST" class = "form">
                <div class = "hidden">
                    <dl>
                        ...
                        <dt>パスワード</dt>
                        <dd><input type = "text" name = "password" value = "{{data[3]}}"></dd>
                        <dt>パスワード(確認用)</dt>
                        <dd><input type = "password" name = "password2" value = {{data[4]}}>
                    </dl>
                </div>
                <p id = "sendbuttoncover">
                    <input type = "submit" value = "登録" id = "sendbutton" formaction = "createduser">
                    <input type = "submit" value = "修正" id = "modifybutton" formaction = "createuser?modify=True">
                </p>
