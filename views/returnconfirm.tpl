        ...
        <div id = "wrapper">
            ...
            <form method = "POST">
                <p id = "sendbuttoncover">
                    <input type = "submit" value = "返却" id = "sendbutton" formaction = "returned?id={{id}}">
                    <input type = "submit" value = "取消" id = "modifybutton" formaction = "return">
                </p>
            </form>
        </div>
    </body>
