...
<html>
    <head>
        <meta charset = "utf-8">
        <title>登録内容の変更 - 研究室 蔵書管理システム - 管理用</title>
        ...
        <div id = "wrapper">
            ...
            <form method = "POST" class = "form">
                ...
                <p id = "sendbuttoncover">
                    <input type = "submit" value = "確定" id = "sendbutton" formaction = "bookmodified?id={{id}}">
                    <input type = "submit" value = "修正" id = "modifybutton" formaction = "bookmodify?modify=True&id={{id}}&fm={{fm}}">
                </p>
