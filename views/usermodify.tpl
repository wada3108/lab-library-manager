            ...
            <form method = "POST" class =  "form">
                <dl>
                    ...
                    <p id = "sendbuttoncover">
                        <input type = "submit" value = "変更" id = "sendbutton" formaction = "usermodify?id={{id}}">
                        <input type = "submit" value = "取消" id = "modifybutton" formaction = "usermodify?id={{id}}&cancel=True">
                    </p>
                </form>
        </div>
    </body>
